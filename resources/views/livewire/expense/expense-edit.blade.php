<div class="max-w-7xl mx-auto py-14 px-4">
    ...
    <form action="" wire:submit.prevent="updateExpense" class="w-full max-w-7xl mx-auto">
        ...
        <div class="w-full py-4 px-3 mb-6 md:mb-0">
            ...
            <button type="submit"
                    class="flex-shrink-0 bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-white py-1 px-2 rounded">Atualizar Registro
            </button>
        </div>
    </form>
</div>
