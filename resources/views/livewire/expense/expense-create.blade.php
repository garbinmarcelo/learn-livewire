<div class="max-w-7xl mx-auto py-14 px-4">
    ...
    <form action="" wire:submit.prevent="createExpense" class="w-full max-w-7xl mx-auto">
        <div class="flex flex-wrap -mx-3 mb-6">
            ...
            <p class="w-full px-3 mb-6 md:mb-0">
                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Data do Comprovante (deixar em branco se for hoje)</label>
                <input type="datetime-local" name="expense_date" wire:model="expense_date"
        ...
        <div class="w-full py-4 px-3 mb-6 md:mb-0">
            ...
            <button type="submit"
                    class="flex-shrink-0 bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-white py-1 px-2 rounded">Criar Registro
            </button>
        </div>
