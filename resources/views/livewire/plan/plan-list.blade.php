<div class="max-w-7xl mx-auto py-15 px-4">
    ...
    <div class="w-full mx-auto text-right my-8">
        <a href="{{route('plans.create')}}"
           class="flex-shrink-0 bg-green-700 hover:bg-green-900 border-green-700 hover:border-green-900 text-sm border-4 text-white py-1 px-2 rounded">Criar Registro</a>
    </div>
